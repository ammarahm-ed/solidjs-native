...
declare global {
  module JSX {
    interface IntrinsicElements {
      ...
      formattedString: NativeScriptProps<
        TFormattedStringAttributes,
        FormattedString
      >;
      ...
      navigationButton: NativeScriptProps<
        TNavigationButtonAttributes,
        NavigationButton
      >;
      ...
      segmentedBarItem: NativeScriptProps<
        TSegmentedBarItemAttributes,
        SegmentedBarItem
      >;
