...
type AccessibilityLiveRegion =
  import("@nativescript/core").AccessibilityLiveRegion;
...
type AndroidActionBarSettings =
  import("@nativescript/core/ui/action-bar").AndroidActionBarSettings;
type AndroidActionItemSettings =
  import("@nativescript/core/ui/action-bar").AndroidActionItemSettings;
...
type FrameNavigationTransition =
  import("@nativescript/core").NavigationTransition;
type GestureEventData = import("@nativescript/core").GestureEventData;
type IOSActionItemSettings =
  import("@nativescript/core/ui/action-bar").IOSActionItemSettings;
...
type RotationGestureEventData =
  import("@nativescript/core").RotationGestureEventData;
...
type SelectedIndexChangedEventData =
  import("@nativescript/core/ui/segmented-bar").SelectedIndexChangedEventData;
...
type TabViewSelectedIndexChangedEventData =
...
type WebViewInterfacesLoadEventData =
  import("@nativescript/core").LoadEventData;
...
export type TTabViewAttributes = Override<
  ViewAttributes,
  {
    ...
    onSelectedIndexChanged?: (
      args: TabViewSelectedIndexChangedEventData
    ) => void;
    selectedIndex?: string | number;
...
export type TViewAttributes = Override<
  ViewBaseAttributes,
  {
    ...
    onAccessibilityIgnoresInvertColorsChange?: (
